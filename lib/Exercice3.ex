defmodule Exercise3 do
  @spec strmul_to_integer(charlist()) :: integer()
  ...
  @spec remove_disable_parts(charlist()) :: charlist()
  ...
  def ex1(lines) do
    lines |> Enum.join() |> get_mul()
  end

  @spec ex1(list(charlist())) :: non_neg_integer()
  def ex2(lines) do
    lines |> Enum.join() |> remove_disable_parts() |> get_mul()
  end
end
