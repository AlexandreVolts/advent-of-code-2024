defmodule Exercise5 do
  ...
  @spec has_matching_pair?(list(pair()), integer(), list(integer())) :: boolean()
  ...
  @spec is_valid_pair?(list(pair()), pair()) :: boolean()
  ...
  @spec reorder_invalid_instruction(list(pair()), list(integer())) :: list(integer())
